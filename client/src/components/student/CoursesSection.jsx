...
const CoursesSection = () => {
  ...
  return (
    <div className="py-16 md:px-40 px-8">
      <h2 className="text-3xl font-medium text-gray-800">Learn from the best tutor</h2>
      ...
      <Link
        ...
        className="inline-block text-gray-500 border border-gray-500/30 px-10 py-3 rounded hover:bg-gray-100 transition"
      >
        Show All Courses
      </Link>
    </div>
