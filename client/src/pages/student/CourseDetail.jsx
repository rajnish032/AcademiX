...
const CourseDetail = () => {
  ...
  const {allCourses , calculateRating, calculateChapterTime,calculateCourseDuration,calculateNoOfLectures,
     currency, backendUrl, userData , getToken } = useContext(AppContext);
...
return courseData ? (
  <>
    <div className="relative flex md:flex-row flex-col-reverse gap-10 items-start justify-between md:px-36 px-8 md:pt-28 pt-20 text-left bg-black min-h-screen text-white">

      {/* 🔹 Glow gradient background */}
      <div
        className="absolute top-0 left-1/2 -translate-x-1/2 w-[650px] h-[380px] 
      ...
      {/* RIGHT COLUMN */}
      <div className="max-w-sm z-10 rounded-xl overflow-hidden bg-white/5 border border-white/10 backdrop-blur-xl shadow-[0_0_35px_rgba(0,0,0,0.9)]">
        {playerData ? (
          <Youtube
